...
\ \ {\isacharbar}\ Some\ c\ {\isasymRightarrow}\ st{\isacharparenleft}who\ {\isacharcolon}{\isacharequal}\ Some\ {\isacharparenleft}c\ {\isacharplus}\ {\isadigit{1}}{\isacharparenright}{\isacharparenright}{\isacharparenright}{\isachardoublequoteclose}\isanewline
\end{isabellebody}
